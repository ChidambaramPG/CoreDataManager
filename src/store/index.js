...
export default new Vuex.Store({
  state: {
    ...
    allColumns: [
      { field: "addedBy", label: "addedBy", numerc: false, html: false },
      { field: "addedOn", label: "addedOn", numerc: false, html: false },
      { field: "converted", label: "converted", numerc: false, html: false },
      ...
      { field: "office_phone", label: "AltPhone", numerc: false, html: false },
      ...
      { field: "status", label: "status", numerc: false, html: false }
    ],
    defaultColumns: [
